...
def mark_your_attendance(request):
	...
	path = 'face_recognition_data/shape_predictor_68_face_landmarks.dat'
...
def view_attendance_home(request):
	...
	return render(request,"recognition/view_attendance_home.html", {'total_num_of_students' : total_num_of_students, 'students_present_today': students_present_today})
